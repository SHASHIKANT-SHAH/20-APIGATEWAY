...
namespace JwtAuthenticationManager
{
    ...
    {
        public const string JWT_SECURITY_KEY = "My Secret key to protect the api and providing validationsjygfduygeayusdfgayuksdfgaksdyfgaysdfgajyusdfgjuysadgfjyasfgjhyagfjahygf";
        private const int JWT_TOKEN_VALIDITY_MINS = 20;
        //private const int JWT_TOKEN_VALIDITY_MAX = 20;
